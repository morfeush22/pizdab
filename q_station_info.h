...
class QStationInfo: public QObject {
    ...
    Q_PROPERTY(quint16 subChannelId READ subChannelId NOTIFY subChannelIdChanged)

    size_t audio_kbps_;
    std::string station_name_;
    quint16 station_id_;
    quint16 sub_channel_id_;
...
public:
    ...
    quint16 subChannelId() const;
    void setSubChannelId(quint16 sub_channel_id);
